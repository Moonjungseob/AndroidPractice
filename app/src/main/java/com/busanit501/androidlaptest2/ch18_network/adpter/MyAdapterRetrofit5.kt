package com.busanit501.androidlaptest2.ch18_network.adpter
...
import com.busanit501.androidlaptest2.ch18_network.model.PublicModel.ItemModel2
import com.busanit501.androidlaptest2.ch18_network.model.publicModel2.AnimalModel
import com.busanit501.androidlaptest2.databinding.ItemRetrofit2Binding
import com.busanit501.androidlaptest2.databinding.ItemRetrofit5Binding
...
class MyAdapterRetrofit5(val context : Context, val datas : List<AnimalModel>?)
    : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        binding.retrofitNameView5.text = item?.sj
        binding.retrofitAddressView5.text = item?.ty3Place
        binding.retrofitTelView5.text = item?.wrter
        val imgurl : String = "https://" + item?.ty3Picture
        Log.d("lsy","이미지 주소 확인 : ${item?.ty3Picture}")
