package com.busanit501.androidlaptest2.ch06_view
...
import com.busanit501.androidlaptest2.databinding.ActivityCh06Test2Binding
...
//        setContentView(R.layout.activity_ch06_test2)
        ...
        ch6LoginBtn.setOnClickListener {
            Toast.makeText(this@Ch06Test2Activity,"mid:${ch06Mid.text.toString()}, mpw:${ch06Mpw.text.toString()}",
        ...
        ch6LoginBtn2.setOnClickListener {
            Toast.makeText(this@Ch06Test2Activity,"mid:${mid2.text.toString()}, mpw:${mpw2.text.toString()}",
                Toast.LENGTH_LONG).show()
        }
